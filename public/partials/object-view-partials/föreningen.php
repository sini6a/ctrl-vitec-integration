...
<div class="row">
    <?php isset($object["association"]["numberOfApartments"]) && $object["association"]["numberOfApartments"] != 0 ? include_once('föreningen-partials/numberOfApartments.php') : null ?>
    <?php isset($object["association"]["numberOfLocals"]) && $object["association"]["numberOfLocals"] != 0 ? include_once('föreningen-partials/numberOfLocals.php') : null ?>
    <?php isset($object["association"]["numberOfRentalUnits"]) && $object["association"]["numberOfRentalUnits"] != 0 ? include_once('föreningen-partials/numberOfRentalUnits.php') : null ?>
    ...
    <?php isset($object["association"]["allowTwinOwnership"]) && $object["association"]["allowTwinOwnership"] != "" ? include_once('föreningen-partials/allowTwinOwnership.php') : null ?>
