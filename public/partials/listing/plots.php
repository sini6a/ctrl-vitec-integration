<?php if ($this->properties->getPlot() != null) {
    foreach ($this->properties->getPlot() as $property): ?>
        <a href="<?php echo add_query_arg(array('object_id' => $property['id'], 'object_type' => 'plot'), get_permalink()) ?>">
            <div class="listing">
                ...
                <div class="listing-content">
                    <p class="listing-content-heading">
                        <?php echo isset ($property['streetAddress']) ? $property['streetAddress'] : "" ?>
                    </p>
                    <p style="text-transform: uppercase;">
                        <?php echo isset ($property['areaName']) ? $property['areaName'] : "" ?>
                    </p>
                    <p>
                        <?php echo isset ($property['livingSpace']) ? $property['livingSpace'] . " m²" . " - " : "" ?>
                        <?php echo isset ($property['price']) ? number_format($property['price'], 0, ',', ' ') . " kr" : "" ?>
                        <?php echo isset ($property["rooms"]) ? " - " . $property["rooms"] . "rum" : "" ?>
                    </p>
                </div>
            </div>
        </a>
